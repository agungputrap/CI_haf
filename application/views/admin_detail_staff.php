...
<div class="container">
	<div class="row">
		<div class="col-md-4 well">
			<h1 align="center"> <?php echo ($data_detail_staff[0]['Nama']) ?> </h1>
			<img src="<?php echo base_url("assets/images/".$data_detail_staff[0]['Username'].".jpg\""); ?>" class="img-responsive img-haf" alt="Responsive image">
		</div>
		<div class="col-md-6 col-md-offset-1">
			<?php foreach ($data_detail_staff[0] as $key => $value) {
