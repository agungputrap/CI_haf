				...
				<legend>EDIT PROFIL</legend>
					<div class="form-group">
		                <div class="row colbox">
			                ...
			                <div class="col-lg-8 col-sm-8">
			                    <input class="form-control" id="txt_nama" name="txt_nama" type="text" value="<?php echo($data[0]['Nama']); ?>" />
			                </div>
		                </div>
	            	</div>
					<div class="form-group">
	            	...
	            	<div class="form-group">
		                <div class="row colbox">
			                ...
			                <div class="col-lg-8 col-sm-8">
			                    <input class="form-control" id="txt_jenis_kelamin" name="jenis_kelamin_staff" type="text" value="<?php echo($data[0]['Jenis_Kelamin']); ?>" />
			                </div>
		                </div>
	            	</div>
	            	<div class="form-group">
		                <div class="row colbox">
			                ...
			                <div class="col-lg-8 col-sm-8">
			                    <input class="form-control" id="txt_bagian" name="bagian" type="text" value="<?php echo($data[0]['Bagian']); ?>" />
			                </div>
		                </div>
	            	</div>
	            	<div class="form-group">
